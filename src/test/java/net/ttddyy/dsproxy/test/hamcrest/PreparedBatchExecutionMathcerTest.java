...
import static net.ttddyy.dsproxy.test.hamcrest.DataSourceProxyMatchers.batchSize;
import static net.ttddyy.dsproxy.test.hamcrest.DataSourceProxyMatchers.param;
import static net.ttddyy.dsproxy.test.hamcrest.DataSourceProxyMatchers.paramAsInteger;
import static net.ttddyy.dsproxy.test.hamcrest.DataSourceProxyMatchers.paramAsString;
